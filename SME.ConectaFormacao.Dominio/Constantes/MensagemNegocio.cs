...
public class MensagemNegocio
{
    ...
    public const string NENHUM_COMPONENTE_CURRICULAR_DOS_ANOS_DA_TURMA_DO_EOL_FORAM_LOCALIZADOS = "Nenhum componente curricular dos anos das turmas do EOL foram encontrados";
}