...
namespace SME.ConectaFormacao.Dominio.Entidades
{
    public class Inscricao : EntidadeBaseAuditavel
    {
        ...
        public PropostaTurma PropostaTurma { get; set; } = new();

        public CargoFuncao Cargo { get; set; } = new();

        public CargoFuncao Funcao { get; set; } = new();
        public Usuario Usuario { get; set; } = new();
        public IEnumerable<CodafInscricaoListaPresenca> CodafInscricoes { get; set; } = [];
        public long? UsuarioAcessibilidadeId { get; set; }
        public UsuarioAcessibilidade? UsuarioAcessibilidade { get; set; }
    }
}
