...
namespace SME.ConectaFormacao.Aplicacao.Teste.Consultas
{
    public class ObterPropostaCompletaPorIdQueryHandlerTestes
    {
        ...
        {
            // Arrange
            IRepositorioArquivo repositorioArquivoNulo = null!;

            // Act
            var act = () => new ObterPropostaCompletaPorIdQueryHandler(
                _mapper.Object,
                _repositorioProposta.Object,
                repositorioArquivoNulo,
                _repositorioPropostaMovimentacao.Object,
                _repositorioAreaPromotora.Object,
                _mediator.Object);

            // Assert
            act.Should().Throw<ArgumentNullException>().WithParameterName("repositorioArquivo");
        }

        [Fact]
        public void DadoRepositorioPropostaMovimentacaoNulo_QuandoInstanciarHandler_EntaoDeveLancarArgumentNullException()
        {
            // Arrange
            IRepositorioPropostaMovimentacao repositorioMovimentacaoNulo = null!;
            ...
            var act = () => new ObterPropostaCompletaPorIdQueryHandler(
                ...
                _repositorioProposta.Object,
                _repositorioArquivo.Object,
                repositorioMovimentacaoNulo,
                _repositorioAreaPromotora.Object,
                _mediator.Object);

            // Assert
            act.Should().Throw<ArgumentNullException>().WithParameterName("repositorioPropostaMovimentacao");
        }

        [Fact]
        public void DadoRepositorioAreaPromotoraNulo_QuandoInstanciarHandler_EntaoDeveLancarArgumentNullException()
        {
            // Arrange
            IRepositorioAreaPromotora repositorioAreaPromotoraNulo = null!;
            ...
            var act = () => new ObterPropostaCompletaPorIdQueryHandler(
                ...
                _repositorioArquivo.Object,
                _repositorioPropostaMovimentacao.Object,
                repositorioAreaPromotoraNulo,
                _mediator.Object);

            // Assert
            act.Should().Throw<ArgumentNullException>().WithParameterName("repositorioAreaPromotora");
        }
