...
{
    public class EnviarEmailInscricaoEmEsperaCommandHandlerTestes
    {
        ...
        private readonly EnviarEmailInscricaoEmEsperaCommandHandler _handler;
        private readonly Faker _faker;

        public EnviarEmailInscricaoEmEsperaCommandHandlerTestes()
        {
            ...
            _faker = new();
            _handler = mocker.CreateInstance<EnviarEmailInscricaoEmEsperaCommandHandler>();
        }
        ...
        {
            // Arrange
            var comando = new EnviarEmailInscricaoEmEsperaCommand(_faker.Random.Long());
            // Act
