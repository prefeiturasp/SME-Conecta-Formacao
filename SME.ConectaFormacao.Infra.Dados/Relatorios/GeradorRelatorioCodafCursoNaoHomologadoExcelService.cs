...
{
    public class GeradorRelatorioCodafCursoNaoHomologadoExcelService(
        ...
        IBlocoAssinaturaGerador blocoAssinatura) : IGeradorRelatorioCodafCursoNaoHomologadoExcelService
    {
        private const string NOME_ARQUIVO_TEMPLATE = "Template_Relatorio_Codaf_Modelo_2026.xlsx";

        public byte[] GerarRelatorio(DadosPrincipaisRelatorioCodafCursoNaoHomologadoDto dadosBrutos)
        {
            var dadosRelatorio = RelatorioCodafCursoNaoHomologadoDto.MapearParaDtoEstruturado(dadosBrutos);
            ...
            foreach (var turma in dadosRelatorio.Turmas)
            {
                ...
                linhaAtual = blocoTitulo.Processar(sheet, linhaAtual, new()
                {
                    ...
                    Titulo2 = "CONTROLE DE DOCUMENTAÇÃO DAS AÇÕES FORMATIVAS - CODAF",
                ...
                // 4º Bloco: Alunos — os 4 grupos exigidos pelos Critérios 05-07
