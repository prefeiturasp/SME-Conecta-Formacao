...
namespace SME.ConectaFormacao.Infra.Dados.Repositorios.Interfaces
{
    public interface IRepositorioAreaPromotora : IRepositorioBaseAuditavel<AreaPromotora>
    {
        ...
        Task<AreaPromotora> ObterPorGrupoIdDresCodigo(Guid grupoId, IEnumerable<string> dresCodigo);
        Task<bool> ExistePorGrupoId(Guid grupoId, long ignorarAreaPromotoraId);
        Task<IEnumerable<AreaPromotora>> ObterListaPorGrupoDresCodigo(Guid grupoId, IEnumerable<string> dresCodigo);
