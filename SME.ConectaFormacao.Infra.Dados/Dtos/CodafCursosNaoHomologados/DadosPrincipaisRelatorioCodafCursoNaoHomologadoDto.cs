...
{
    public class DadosPrincipaisRelatorioCodafCursoNaoHomologadoDto
    {
        ...
        public IEnumerable<DadosParticipanteRelatorioCodafCursoNaoHomologadoDto>? Participantes { get; set; }
    }
}