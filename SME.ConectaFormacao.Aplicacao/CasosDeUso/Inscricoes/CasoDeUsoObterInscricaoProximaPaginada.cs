...
namespace SME.ConectaFormacao.Aplicacao.CasosDeUso.Inscricoes
{
    ...
    {
        public CasoDeUsoObterInscricaoProximaPaginada(IMediator mediator, IContextoAplicacao contextoAplicacao) : base(mediator, contextoAplicacao)
        {
        }
        ...
        public async Task<PaginacaoResultadoDto<InscricaoPaginadaDTO>> Executar()
        {
            ...
            return await mediator.Send(new ObterInscricaoProximaPaginadaQuery(usuarioLogado.Id, NumeroPagina, NumeroRegistros));
        }
    }
}
