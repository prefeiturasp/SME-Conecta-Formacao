...
namespace SME.ConectaFormacao.Aplicacao.CasosDeUso.Inscricao
{
    public class CasoDeUsoObterInscricaoPorId : CasoDeUsoAbstratoPaginado, ICasoDeUsoObterInscricaoPorId
    {
        ...
        public async Task<PaginacaoResultadoComMensagemDTO<DadosListagemInscricaoDTO>> Executar(long propostaId, FiltroListagemInscricaoDTO filtroListagemInscricaoDTO)
        {
