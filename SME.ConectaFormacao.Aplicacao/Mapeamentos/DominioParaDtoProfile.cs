    ...
    public class DominioParaDtoProfile : Profile
    {
        ...
        private void MapPropostaParaDTO()
        {
            ...
            CreateMap<Proposta, PropostaPaginadaDTO>()
                ...
                .ForMember(dest => dest.TipoEmissor, opt => opt.MapFrom(x => x.TipoEmissor.HasValue ? x.TipoEmissor.Nome() : null))
                ...
                .ForMember(dest => dest.IdEmissor, opt => opt.MapFrom(x => x.IdEmissor != 0 ? x.IdEmissor : 0))
        ...
        private void MapOutros()
        {
            ...
            CreateMap<FormacaoDetalhada, RetornoFormacaoDetalhadaDTO>()
                ...
                .ForMember(dest => dest.SobreEsteCurso, opt => opt.MapFrom(x => x.SobreEsteCurso != null && x.SobreEsteCurso != "" ? x.SobreEsteCurso.RemoverTagsHtml() : ""))
