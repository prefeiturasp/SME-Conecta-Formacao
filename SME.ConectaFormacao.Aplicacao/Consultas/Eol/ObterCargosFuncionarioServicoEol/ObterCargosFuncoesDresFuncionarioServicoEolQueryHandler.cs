...
{
    public class ObterCargosFuncoesDresFuncionarioServicoEolQueryHandler : IRequestHandler<ObterCargosFuncoesDresFuncionarioServicoEolQuery, IEnumerable<CargoFuncionarioConectaDTO>>
    {
        ...
        public async Task<IEnumerable<CargoFuncionarioConectaDTO>> Handle(ObterCargosFuncoesDresFuncionarioServicoEolQuery request, CancellationToken cancellationToken)
        {
