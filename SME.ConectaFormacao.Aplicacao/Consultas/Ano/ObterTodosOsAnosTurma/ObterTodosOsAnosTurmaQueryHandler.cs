...
{
    public class ObterTodosOsAnosTurmaQueryHandler : IRequestHandler<ObterTodosOsAnosTurmaQuery, IEnumerable<AnoTurma>>
    {
        ...
        public async Task<IEnumerable<AnoTurma>> Handle(ObterTodosOsAnosTurmaQuery request, CancellationToken cancellationToken)
        {
