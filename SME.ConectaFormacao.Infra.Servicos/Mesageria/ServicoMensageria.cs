...
namespace SME.ConectaFormacao.Infra
{
    ...
    public class ServicoMensageriaConecta : ServicoMensageria<MensagemRabbit>, IServicoMensageriaConecta
    {
    ...
    {
        public ServicoMensageriaMetricas(IConexoesRabbitLogs conexaoRabbit, IServicoTelemetria servicoTelemetria, IReadOnlyPolicyRegistry<string> registry) : base(conexaoRabbit, servicoTelemetria, registry)
        {
        }
