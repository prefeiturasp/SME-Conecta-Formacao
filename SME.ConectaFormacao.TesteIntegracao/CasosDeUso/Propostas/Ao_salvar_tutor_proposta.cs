...
using SME.ConectaFormacao.TesteIntegracao.CasosDeUso.Propostas.ServicosFakes;
...
namespace SME.ConectaFormacao.TesteIntegracao.CasosDeUso.Propostas
{
    public class Ao_salvar_tutor_proposta : TestePropostaBase
    {
        ...
        public async Task Nao_deve_cadastrar_tutor_com_turma_duplicada()
        {
            ...
            var mensagem = string.Format(MensagemNegocio.JA_EXISTE_ESSA_TURMA_PARA_ESSE_TURTOR, tutor.NomeTutor, proposta.Turmas.FirstOrDefault().Nome);
