...
{
    public class Ao_alterar_email_de_confirmacao_de_usuario_retorno_invalido : TesteBase
    {
        public Ao_alterar_email_de_confirmacao_de_usuario_retorno_invalido(CollectionFixture collectionFixture, bool limparBanco = true) : base(collectionFixture, limparBanco)
        {
        }
        protected override void RegistrarQueryFakes(IServiceCollection services)
        {
            base.RegistrarQueryFakes(services);
            services.Replace(new ServiceDescriptor(typeof(IRequestHandler<ObterUsuarioServicoAcessosPorLoginSenhaQuery, UsuarioAutenticacaoRetornoDTO>), typeof(ObterUsuarioServicoAcessosPorLoginSenhaQueryHandlerRetornoInvalido), ServiceLifetime.Scoped));
        }
