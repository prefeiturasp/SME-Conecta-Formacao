...
select 'ComunicadoAcaoFormativaUrl', 
		...
		'https://www.sinesp.org.br/179-saiu-no-doc/11314-comunicado-n-1-043-de-16-12-2020-dispoe-sobre-o-encaminhamento-de-titulos-para-fins-de-cadastramento-no-sistema-informatizado-da-sme-escola-on-line',
		2023,
		true,
		now(),
		'Sistema',
