CREATE TABLE IF NOT EXISTS public.proposta (
	...
	funcao_especifica_outros varchar(100) null,
	criterio_validacao_inscricao_outros varchar(200) null,
	...
	CONSTRAINT proposta_area_promotora_fk  foreign key (area_promotora_id) references public.area_promotora(id)
);
...
create table if not exists public.proposta_criterio_validacao_inscricao (
	id int8 NOT NULL GENERATED ALWAYS AS IDENTITY( NO MINVALUE NO MAXVALUE NO CYCLE),
	proposta_id int8 not null,
	...
	alterado_login varchar(200) NULL,
	excluido boolean NOT NULL,
	CONSTRAINT proposta_criterio_validacao_inscricao_pk PRIMARY KEY (id),
	constraint proposta_criterio_validacao_inscricao_proposta_fk foreign key (proposta_id) references public.proposta(id),
	constraint proposta_criterio_validacao_inscricao_crit_valiacao_prop_fk foreign key (criterio_validacao_inscricao_id) references public.criterio_validacao_inscricao(id)
);
