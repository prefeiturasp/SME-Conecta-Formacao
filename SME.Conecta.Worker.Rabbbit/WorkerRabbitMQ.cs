...
namespace SME.Conecta.Worker
{
    public sealed class WorkerRabbitMQ : WorkerRabbitConecta
    {
        ...
        protected override void RegistrarUseCases()
        {
            ...
            Comandos.Add(RotasRabbit.RealizarInscricaoAutomaticaTratarCursistas, new ComandoRabbit("Realizar Inscrições Automáticas - Iterar sobre os cursistas e coletar o usuário logado", typeof(ICasoDeUsoRealizarInscricaoAutomaticaTratarCursista), true));
            Comandos.Add(RotasRabbit.RealizarInscricaoAutomaticaIncreverCursista, new ComandoRabbit("Realizar Inscrições Automáticas - Iterar sobre os cursistas e coletar o usuário logado", typeof(ICasoDeUsoRealizarInscricaoAutomaticaInscreverCursista), true));
        }
    }
}