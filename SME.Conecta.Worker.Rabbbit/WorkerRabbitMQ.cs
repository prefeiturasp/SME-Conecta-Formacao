...
namespace SME.Conecta.Worker
{
    public sealed class WorkerRabbitMQ : WorkerRabbitConecta
    {
        ...
        protected override void RegistrarUseCases()
        {
            ...
            Comandos.Add(RotasRabbit.SincronizaFuncaoAtividadeDre, new ComandoRabbit("Sincronização por Função Atividade DRE/SME", typeof(ISincronizarFuncaoAtividadeEolPorDreUseCase), false));
            ...
            Comandos.Add(RotasRabbit.NotificarAreaPromotoraSobreValidacaoFinalPelaDF, new ComandoRabbit("Notificar Área promotora sobre a validação final pela DF", typeof(ICasoDeUsoNotificarAreaPromotoraSobreValidacaoFinalPelaDF), true));
